...
public class Electrochemistry extends AppCompatActivity {
...
//private int totalsizeofquiz=0;
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrochemistry);
...
//finalactivity = new FinalActivity(this);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Electro");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Electrochemistry.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Electrochemistry.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Electrochemistry.this, SweetAlertDialog.ERROR_TYPE)
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()) {
            // Intent intent =new Intent(Mixture.this,ScienceQuiz.class);
    ...
    private void finalResult(){
        Intent resultData = new Intent(Electrochemistry.this,ElectrochemistryResults.class);
