...
public class MixedQuiz2 extends AppCompatActivity {
...
//finalactivity = new FinalActivity(this);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Final");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(MixedQuiz2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            /*new SweetAlertDialog(MixedQuiz.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
          ...
          /*  new SweetAlertDialog(MixedQuiz.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(MixedQuiz2.this,sciencequiz_test.class);
