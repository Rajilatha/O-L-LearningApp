...
public class ResultsActivity2 extends AppCompatActivity {
    ...
    public static final String SHARED_PREFERRENCE_HIGH_SCORE = "shared_prefrence_high_score";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btMainMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ResultsActivity2.this, MathsQuiz.class);
        ...
        btStartQuiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ResultsActivity2.this, Binomial.class);
                startActivity(intent);
            }
        });
        loadHighScore();
