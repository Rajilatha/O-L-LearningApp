...
public class Waves2 extends AppCompatActivity {
...
//finalactivity = new FinalActivity(this);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Waves");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Waves2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Waves2.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Waves2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Waves2.this,sciencequiz_test.class);
