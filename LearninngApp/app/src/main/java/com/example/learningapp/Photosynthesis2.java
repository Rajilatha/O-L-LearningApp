...
public class Photosynthesis2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Photo");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Photosynthesis2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Photosynthesis2.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Photosynthesis2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Photosynthesis2.this,sciencequiz_test.class);
