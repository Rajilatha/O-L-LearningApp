...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // b2=(Spinner) findViewById(R.id.spinner);
        ...
        //ArrayAdapter<CharSequence> adapter =ArrayAdapter.createFromResource(this,R.array.usertype);
            ...
            public void onClick(View v) {
                ...
                if(chklogin==true) {
                    ...
                    startActivity(new Intent(LoginActivity.this, SelectionActivity.class));
                        ...
                        else if(e1.getText().toString().equals("maths") && e2.getText().toString().equals("maths")){
                            Toast.makeText(getApplicationContext(), "Successfully Login", Toast.LENGTH_LONG).show();
                            startActivity(new Intent(LoginActivity.this, mathsadmin.class));
                        }
                        else if(e1.getText().toString().equals("science") && e2.getText().toString().equals("science") ){
                            Toast.makeText(getApplicationContext(), "Successfully Login", Toast.LENGTH_LONG).show();
                            startActivity(new Intent(LoginActivity.this, adminscience.class));
                        }

                else{
                    Toast.makeText(getApplicationContext(),"Invalid Attemp",Toast.LENGTH_LONG).show();
                }
            }
        });
