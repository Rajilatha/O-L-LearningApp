...
public class Geometrical extends AppCompatActivity {
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Geometrical.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Geometrical.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Geometrical.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Geometrical.this,GeometricalResults.class);
