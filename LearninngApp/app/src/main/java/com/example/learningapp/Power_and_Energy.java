...
public class Power_and_Energy extends AppCompatActivity {
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Power_and_Energy.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Power_and_Energy.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Power_and_Energy.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Power_and_Energy.this,PowerResults.class);
