...
public class Power_and_Energy2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Power");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Power_and_Energy2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Power_and_Energy2.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Power_and_Energy2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Power_and_Energy2.this,sciencequiz_test.class);
