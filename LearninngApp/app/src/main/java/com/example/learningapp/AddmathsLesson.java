...
public class AddmathsLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addmaths_lesson);
            ...
            public void onClick(View v) {
                ...
                if(notesvalue.equals("")||typevalue.equals("")){
                    ...
                    if (insert == true) {
                        ...
                        Intent moveToNext = new Intent (AddmathsLesson.this,AddmathsLesson.class);
