...
public class Hydrocarbons2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hydrocarbons);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Hydrocarbons");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Hydrocarbons2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Hydrocarbons2.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            new SweetAlertDialog(Hydrocarbons2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Hydrocarbons2.this,sciencequiz_test.class);
