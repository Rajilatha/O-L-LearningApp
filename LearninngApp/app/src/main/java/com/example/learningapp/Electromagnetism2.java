...
public class Electromagnetism2 extends AppCompatActivity {
...
//finalactivity = new FinalActivity(this);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = dbHelper.getQuestionswithType("Electromagnetism");
...
// Vibrate for 500 milliseconds
                        ...
                        Toast.makeText(Electromagnetism2.this, "Please select a answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
...
// Vibrate for 500 milliseconds
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNr()) {
            ...
            new SweetAlertDialog(Electromagnetism2.this, SweetAlertDialog.SUCCESS_TYPE)
...
// Vibrate for 500 milliseconds
            ...
            FLAG=2;
            playAudioForAnswer.setAudioforAnswer(FLAG);
            new SweetAlertDialog(Electromagnetism2.this, SweetAlertDialog.ERROR_TYPE)
    ...
    private void finalResult(){
        Intent resultData = new Intent(Electromagnetism2.this,sciencequiz_test.class);
