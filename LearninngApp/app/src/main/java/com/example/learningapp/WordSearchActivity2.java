...
public class WordSearchActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_word__search);
            ...
            public void onClick(View view) {
                ...
                if (!res.isEmpty()) {
                    ...
                    if (gameBoard.getScore() == gameBoard.getMaxScore()) {
                        Intent intent = new Intent(mContext, EndGame2.class);
        ...
        words = Arrays.asList("Xylem", "Phloem","tissue", "Blood", "Muscle", "Sucrose", "Oxygen", "solution","sodium");
